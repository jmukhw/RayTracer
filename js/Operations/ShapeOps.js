 ...
 * @return {Color}
 */
function Lighting(material, light, point, eyev, normalv, in_shadow = 0) {
...
function ShadeHit(world, comps) {
    ...
    for (let i = 0; i < world.lights.length; i++) {
        ...
        let l = Lighting(comps.object.material, world.lights[i], comps.point, comps.eyev, comps.normalv, shadowed);
        c = c.Add(l);
    }
    return c;
}
